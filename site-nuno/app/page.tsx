...
export default function SitePsicologo() {
  ...
  const interventions = [
    ...
    { id: "psicadelicos", title: "Preparação e Integração de Experiências Psicadélicas", icon: <BookOpen className="w-6 h-6" />, text: "Acompanhamento especializado antes e após vivências em estados ampliados de consciência. Focado na preparação emocional, redução de riscos e na integração segura de insights em mudanças positivas no quotidiano." },
